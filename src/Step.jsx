        ...
        <div className="w-[500px] m-auto">
            ...
            {isOpen && <div className="bg-gray-100 rounded-lg mt-6 p-6">
                ...
                <div className="flex justify-around items-center">
                    <Button bgColor={'bg-indigo-500'} textColor={'text-white'} text={'Previous'} onClick={handlePrevious} />
                    <Button bgColor={'bg-indigo-500'} textColor={'text-white'} text={'Next'} onClick={handleNext} />
                </div>
            </div>}
        </div>
    )
